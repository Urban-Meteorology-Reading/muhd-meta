...
list_author=['Sue Grimmond http://orcid.org/0000-0002-3166-9415',
             ...
             'Andy Gabey','Kjell zum Berge','Lukas Pauscher',
             'Brian Offerle','Jess Brown',
...
def source_read_handler(app, docname, source):
    ...
    str_GHPage=f"""
.. _GitHub Issues: https://github.com/Urban-Meteorology-Reading/muhd-meta/issues/new?assignees=&labels=docs&template=docs-issue-report.md&body=[page-link](https://github.com/Urban-Meteorology-Reading/{str_repo}/blob/master/{str_base}/{docname}.rst)&title=[Docs]{docname}
"""
    rendered='\n'.join([str_GHPage,src])
